    ...
    body = (
      ...
      >
        ...
        <div>
          ...
          >
            No game match is currently active. Connect and select a game in the Games lobby to start
            playing.
          </span>
        </div>
        <button
  ...
  return (
    <div
      style={{
        ...
        background:
          'radial-gradient(circle at center, rgba(30, 30, 36, 0.3) 0%, rgba(15, 15, 18, 0.7) 100%)',
      }}
    >
      {body}
    </div>
