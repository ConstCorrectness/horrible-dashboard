...
:::note
"Trajectory" here means *a flow through the system*, drawn as a sequence diagram.
For trajectories as **stored, queryable data** — recording what an agent did so you
can search it, grade it and compare harnesses — see
[the trajectories module](../modules/trajectories.mdx).
:::
