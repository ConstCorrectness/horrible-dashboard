...
**The first ceiling is memory, not CPU** — measured, not assumed, and this file
said CPU until it was. The host captures the desktop at its native resolution on
...
2 GB, the `shared-cpu-1x` maximum.
