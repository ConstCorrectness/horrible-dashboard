...
A panel is a view that opens as a pane in the workspace frame.
...
| Field | Requirement |
|-------|-------------|
| `role` | How the pane participates in the frame (document/tool/widget zones) |
