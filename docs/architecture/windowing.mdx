...
**▾ pane-view switcher** (`changePaneType`). Built-in presets: **Dashboard**,
**Scripting**, and **Coding Harnesses**. `scratch.note` is the reference non-singleton panel. Not yet: a
