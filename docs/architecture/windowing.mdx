...
- **Workspaces are full frames (Blender model).** A workspace persists
  ...
  **Research** (console/arxiv/browser beside the viewers + library — see
  [research](../modules/research.mdx)), **Coding Harnesses**, plus
  module-contributed ones (**DashArena** from the games module, Training,
  Notebook, Orchestration); `layout.reset` restores the preset.
