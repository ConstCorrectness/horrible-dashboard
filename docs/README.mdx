...
flowchart TB
    subgraph FE["Frontend — one React app, two layouts"]
        ...
        Mods["Modules<br/>agent · dashboard · editor · files · terminal ·<br/>observability · marketplace · settings · clubhouse · scratch"]
...
(note/file buffers + recent-notes widget), **file explorer**, and **terminal**
(PTY). The **agent tool & permission surface**
