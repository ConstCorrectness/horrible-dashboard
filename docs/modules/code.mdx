...
This is Slice 1 of the coding-panes work — the spine everything else stands on.
Semantic search + a cross-repo find palette, and a git provenance pane, build on it
later.
...
| Panel | Id | Role | What |
| --- | --- | --- | --- |
| Symbol Outline | `code.outline` | singleton, left | The current file's definitions; follows the cursor, drives the locus on click. |
