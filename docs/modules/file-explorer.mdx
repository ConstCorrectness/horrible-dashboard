...
| **Context menu**        | right-click → Open / New File / New Folder / Rename / Delete / Copy Path / Open Terminal Here, contributed as a `files.node` provider (see [Context menus](../architecture/context-menus.mdx)) |
