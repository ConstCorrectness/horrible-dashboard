...
| --- | --- |
| **Play** | Map, then **Train** (alone, nothing shooting back) or **Host** (a match here, with bots) |
...
**Train is deliberately not a match.** It is one player on a map with nothing to
shoot, which is what learning the movement wants: the chained-jump timing and the
shoot-jump are exactly the sort of thing to practise before somebody is aiming at you.
