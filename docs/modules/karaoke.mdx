...
| --- | --- | --- |
| Video, ffmpeg present | `VIDEO_FORMAT`: `bv*[vcodec^=avc1][height<=720]+ba[ext=m4a]`, then any mp4 video ≤720p + m4a, then a single file | merged `.mp4`, `ffmpeg_location` passed explicitly |
