...
| `records.list` | tool (`embedded`) | Table switcher, search, and the pending-proposal count. The **Tables** section of [Explorer](explorer.mdx); the CRM and Data Entry presets dock Explorer on the left. |
