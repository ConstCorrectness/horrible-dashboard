...
- **Panels:**
  ...
  - `flow.library` — list of saved flows; create/open/delete. `embedded`: the **Flows** section of [Explorer](explorer.mdx), and still the left region strip of `flow.editor`.
...
- **Panels:** `flow.editor` (document, multi-instance — one pane per open flow
  ...
  param), `flow.library` (tool, `embedded` — a section of [Explorer](explorer.mdx)). `flow.runs` is Phase 2.
