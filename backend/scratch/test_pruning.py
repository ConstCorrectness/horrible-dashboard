...
async def main():
    ...
    prompt2 = "Please perform a semantic search in my vectordb collection for 'ai projects'"
    ...
    vectordb_included = any(t['function']['name'].startswith("vectordb.") for t in pruned2)
