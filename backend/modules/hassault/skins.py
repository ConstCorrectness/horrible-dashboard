...
SKIN_CATALOG: list[SkinDefinition] = [
    ...
    SkinDefinition(
        ...
        description="Skeletonized drop-point blade with central spinning ring and blood-red spiderweb lacquer.",
    ),
    SkinDefinition(
        ...
        accent_color="#f43f5e",
        pattern_type="fade",
        description="High-mobility skeleton knife finished with an airbrushed chromatic fade gradient.",
    ),
    SkinDefinition(
        ...
        accent_color="#2563eb",
        pattern_type="patina",
        description="Massive survival tanto with sawback spine, heat-treated with brilliant blue gem mottling.",
    ),
    SkinDefinition(
        id="knife_huntsman_slaughter",
        ...
        accent_color="#7f1d1d",
        pattern_type="anodized",
        description="Heavy survival combat knife finished in reflective ruby zebra chrome.",
    ),
    SkinDefinition(
        id="knife_damascus",
        name="Damascus Steel",
    ...
    SkinDefinition(
        ...
        accent_color="#7f1d1d",
        pattern_type="anodized",
        description="Painted in a zebra stripe motif using aluminium and chrome paints with varying reflectivities.",
    ),
    SkinDefinition(
        id="knife_night",
        name="Night Ops",
        ...
        accent_color="#334155",
        pattern_type="solid",
        description="Coated in individual parts with solid spray paints in deep midnight blue and obsidian.",
    ),
    SkinDefinition(
        id="knife_ddpat",
        name="Forest DDPAT",
        ...
        accent_color="#14532d",
        pattern_type="camo",
        description="Hydrographic digital woodland camouflage pattern designed for woodland skirmishes.",
    ),
    SkinDefinition(
        id="knife_case_hardened",
        name="Case Hardened",
        weapon_id="knife",
        rarity=Rarity.SPECIAL,
        ...
        accent_color="#2563eb",
        pattern_type="patina",
        description="Color case-hardened through the application of charcoal at high temperatures creating vibrant blue gems.",
    ),
    SkinDefinition(
        id="knife_tiger_tooth",
        name="Tiger Tooth",
        weapon_id="knife",
        rarity=Rarity.SPECIAL,
        collection="Chroma Collection",
        ...
        accent_color="#78350f",
        pattern_type="anodized",
        description="Anodized deep orange and hand-etched with ferocious tiger striping.",
    ),
    # Covert (Red - Ancient)
    SkinDefinition(
