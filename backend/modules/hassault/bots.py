...
TACTICAL_COVER_NODES: dict[str, list[tuple[float, float, str]]] = {
    ...
    "hd_inferno": [
        (54.0, 84.0, "banana_car_cover"),
        (45.0, 105.0, "banana_sandbags"),
        (59.0, 150.0, "site_b_fountain"),
        (66.0, 156.0, "site_b_coffins"),
        (108.0, 90.0, "boiler_room_door"),
        (138.0, 126.0, "apts_balcony"),
        (162.0, 132.0, "site_a_pit"),
        (150.0, 150.0, "site_a_default"),
        (165.0, 168.0, "site_a_graveyard"),
    ],
    "hd_mirage": [
        (135.0, 84.0, "site_a_tetris"),
        (142.0, 78.0, "site_a_triple"),
        (114.0, 72.0, "site_a_ticket"),
        (144.0, 114.0, "palace_balcony"),
        (100.0, 144.0, "mid_window_room"),
        (120.0, 114.0, "connector_ramp"),
        (84.0, 108.0, "catwalk_walkway"),
        (48.0, 132.0, "site_b_van"),
        (51.0, 150.0, "site_b_pillar"),
