...
POPULAR_VOICES = [
    {"name": "en-US-AndrewMultilingualNeural", "gender": "Male", "locale": "en-US", "label": "Andrew (US Male - Ultra-Natural & Warm)"},
    {"name": "en-US-AvaMultilingualNeural", "gender": "Female", "locale": "en-US", "label": "Ava (US Female - Ultra-Natural & Conversational)"},
    {"name": "en-US-BrianMultilingualNeural", "gender": "Male", "locale": "en-US", "label": "Brian (US Male - Engaging & Friendly)"},
    {"name": "en-US-EmmaMultilingualNeural", "gender": "Female", "locale": "en-US", "label": "Emma (US Female - Cheerful & Clear)"},
    ...
    {"name": "en-IN-NeerjaNeural", "gender": "Female", "locale": "en-IN", "label": "Neerja (IN Female - Professional)"},
...
_CACHE_MAX_SIZE = 256
_audio_cache: collections.OrderedDict[tuple[str, str, str, str, str], bytes] = collections.OrderedDict()
