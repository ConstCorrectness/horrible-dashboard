...
def export_glb():
    """Exports the entire facility scene to GLB for native FPS and Web runtime."""
    ...
    backend_glb_path = os.path.join(backend_map_dir, "hd_facility.glb")
    web_glb_path = os.path.join(web_public_dir, "hd_facility.glb")
    ...
    print("=== Facility Generation & Export Complete! ===")
